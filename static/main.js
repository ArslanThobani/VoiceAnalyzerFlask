...
function openForm() {
 ...
 document.getElementById("myForm").style.top = rect.top-100;
 document.getElementById("myForm").style.left= rect.left+100;
...
function showUploadForm() {
 var rect = document.getElementById( "record").getBoundingClientRect();
 console.log(rect.top, rect.right, rect.bottom, rect.left);
 document.getElementById("myUploadForm").style.top = rect.top-300;
 document.getElementById("myUploadForm").style.left= rect.left+100;
